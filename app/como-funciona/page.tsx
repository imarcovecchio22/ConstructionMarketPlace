  ...
  return (
    <div className="container py-10">
              ...
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <div className="md:w-2/3">
                  ...
                  <div className="flex flex-wrap gap-4">
                    <Link href="/como-funciona/profesionales">
            ...
            <section className="bg-muted p-8 rounded-lg">
              <div className="flex flex-col md:flex-row gap-8 items-center">
                <div className="md:w-2/3">
                  ...
                  <p className="text-muted-foreground mb-6">
                    Unite a miles de profesionales que ya están expandiendo su cartera de clientes con ConstruConecta.
                  </p>
                  <div className="flex flex-wrap gap-4">
                    ...
                    <Link href="/dashboard">
                      <Button variant="outline">Ver Panel de Control</Button>
                    </Link>
                  </div>
                </div>
                <div className="md:w-1/3 flex justify-center">
      ...
      <section className="mt-16 text-center">
        <h2 className="text-3xl font-bold mb-6">¿Necesitás más ayuda?</h2>
        <p className="text-lg text-muted-foreground mb-8 max-w-[700px] mx-auto">
          Nuestro equipo de soporte está disponible para responder cualquier pregunta que puedas tener sobre cómo usar
          ConstruConecta.
        </p>
