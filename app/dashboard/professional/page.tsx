...
export default function ProfessionalDashboard() {
  ...
  const professionalId = "plomeria-1"
  const professionalName = "Carlos Rodríguez"
  const professionalProfession = "Plomero Matriculado"
      ...
      <div className="hidden w-64 border-r bg-muted/40 md:block">
        ...
        <div className="p-4">
          <nav className="grid gap-2">
            ...
            <Button variant="ghost" className="justify-start" asChild>
              <Link href="/professionals/edit-profile">
      ...
      <div className="flex-1">
        ...
        <main className="p-6">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            <h1 className="text-2xl font-bold">Panel de Profesional</h1>
                    ...
                    <Card key={job.id}>
                      <CardContent className="p-4 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          <Avatar>
                            <AvatarImage src={job.image || "/placeholder.svg"} alt={job.client} />
                  ...
                  {[
                    ...
                    <Card key={request.id}>
                      <CardContent className="p-4 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          <Avatar>
                            <AvatarImage src={request.image || "/placeholder.svg"} alt={request.client} />
                    ...
                    <Card key={review.id}>
                      <CardContent className="p-4">
                        <div className="flex justify-between items-start">
                          <div className="flex items-center gap-4">
                            <Avatar>
                              <AvatarImage src={review.image || "/placeholder.svg"} alt={review.client} />
